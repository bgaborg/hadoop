  ...
  private DynamoDB createDynamoDB(
    ...
    if (amazonDynamoDB == null) {
      ...
      final Class<? extends DynamoDBClientFactory> cls =
          configuration.getClass(S3GUARD_DDB_CLIENT_FACTORY_IMPL,
      ...
      amazonDynamoDB = ReflectionUtils.newInstance(cls, configuration)
          .createDynamoDBClient(s3Region, bucket, awsCredentialsProvider);
    }
