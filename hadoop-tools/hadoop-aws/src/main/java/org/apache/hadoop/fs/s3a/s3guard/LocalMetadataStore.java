...
public class LocalMetadataStore implements MetadataStore {
  ...
  public static final int DEFAULT_CACHE_ENTRY_TTL_SECONDS = 10;
  ...
  /* Null if this FS does not have an associated URI host. */
  ...
  public void initialize(Configuration conf) throws IOException {
    ...
    int expiryAfterWrite = conf.getInt(CONF_CACHE_ENTRY_TTL,
